...
static PyObject *__pyx_pf_9rectangle_11PyRectangle_4getArea(struct __pyx_obj_9rectangle_PyRectangle *__pyx_v_self); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_9rectangle_11PyRectangle_5getArea(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused); /*proto*/
static PyObject *__pyx_pw_9rectangle_11PyRectangle_5getArea(PyObject *__pyx_v_self, CYTHON_UNUSED PyObject *unused) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("getArea (wrapper)", 0);
  __pyx_r = __pyx_pf_9rectangle_11PyRectangle_4getArea(((struct __pyx_obj_9rectangle_PyRectangle *)__pyx_v_self));
...
static PyObject *__pyx_pf_9rectangle_11PyRectangle_4getArea(struct __pyx_obj_9rectangle_PyRectangle *__pyx_v_self) {
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_v_self->thisptr->getArea()); if (unlikely(!__pyx_t_1)) __PYX_ERR(1, 16, __pyx_L1_error)
...
static PyObject *__pyx_pw_9rectangle_11PyRectangle_7move(PyObject *__pyx_v_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_dy)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("move", 1, 2, 2, 1); __PYX_ERR(1, 17, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "move") < 0)) __PYX_ERR(1, 17, __pyx_L3_error)
      }
  ...
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("move", 1, 2, 2, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(1, 17, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 *         self.thisptr.move(dx, dy)             # <<<<<<<<<<<<<<
 */
  __pyx_t_1 = __Pyx_PyInt_As_int(__pyx_v_dx); if (unlikely((__pyx_t_1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 18, __pyx_L1_error)
  __pyx_t_2 = __Pyx_PyInt_As_int(__pyx_v_dy); if (unlikely((__pyx_t_2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(1, 18, __pyx_L1_error)
...
static PyMethodDef __pyx_methods_9rectangle_PyRectangle[] = {
  {"getArea", (PyCFunction)__pyx_pw_9rectangle_11PyRectangle_5getArea, METH_NOARGS, 0},
  {"move", (PyCFunction)__pyx_pw_9rectangle_11PyRectangle_7move, METH_VARARGS|METH_KEYWORDS, 0},
...
static int __Pyx_modinit_type_init_code(void) {
  ...
  /*--- Type init code ---*/
  if (PyType_Ready(&__pyx_type_9rectangle_PyRectangle) < 0) __PYX_ERR(1, 9, __pyx_L1_error)
  ...
  if (PyObject_SetAttrString(__pyx_m, "PyRectangle", (PyObject *)&__pyx_type_9rectangle_PyRectangle) < 0) __PYX_ERR(1, 9, __pyx_L1_error)
  if (__Pyx_setup_reduce((PyObject*)&__pyx_type_9rectangle_PyRectangle) < 0) __PYX_ERR(1, 9, __pyx_L1_error)
